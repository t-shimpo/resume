...
バックエンドの開発を中心に、2022/12~フロントエンドの開発も担当しています。
...
**主な担当業務**
- React, Chakra UIを用いた画面実装
- ユーザー情報登録画面や写真提出画面をReact Hook Form を使用して実装
- Storybookのストーリーを追加

使用技術： Typescript / React / Next.js / Chakra UI / Storybook
...
## 自己PR
バックエンド開発を中心にフロントエンド開発も担当してきました。
その中で、経験したことがなかったRuby on RailsでのGraphQLのmutationの実装、React Hook Formを使用したフォームの実装などを担当しており、新しい技術への挑戦は厭いません。
